...
# Feeling dizzy! Have some rest.
wttr() { curl wttr.in/Ahmedabad }
hmmm() { curl wttr.in/Kingston,Ontario }
hmmmm(){
    clear;
    sleep 0.5; printf "Have a Good Night !!! Bye";
    sleep 0.2; printf "ee";
    sleep 0.2; printf "ee";
    sleep 0.2; printf "ee";
    sleep 0.2; printf "ee";
...
alias clear='draw_name'
alias cls='draw_name'
alias lol='exit;exit;exit;exit;exit;exit;exit;exit;exit;exit;exit;exit;'
